...
cl::opt<std::string> installDefaultLibPath("install-default-lib-to-path", cl::desc("Install Default Library to folder/directory. (used in install-default-lib)"), cl::cat(TypeScriptCompilerCategory));
