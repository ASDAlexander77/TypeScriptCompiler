...
void finishSwitchState(mlir_ts::FuncOp f, TSFunctionContext &tsFuncContext)
{
    ...
    rewriter.replaceOpWithNewOp<mlir_ts::SwitchStateInternalOp>(switchStateOp, switchStateOp.state(), switchStateOp.defaultDest(),
                                                                stateLabels);
}
...
void TypeScriptToAffineLoweringPass::runOnFunction()
{
    ...
    target.addLegalOp<
        ...
        mlir_ts::ParseIntOp, mlir_ts::PrintOp, mlir_ts::SizeOfOp, mlir_ts::StoreOp, mlir_ts::SymbolRefOp, mlir_ts::LengthOfOp,
        mlir_ts::StringLengthOp, mlir_ts::StringConcatOp, mlir_ts::StringCompareOp, mlir_ts::LoadOp, mlir_ts::NewOp, mlir_ts::CreateTupleOp,
