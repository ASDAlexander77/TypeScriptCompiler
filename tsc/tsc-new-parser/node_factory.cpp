...
namespace ts
{
        ...
        Expression initializer) -> ParameterDeclaration
    {
        ...
        // @api
        auto createDecorator(expression: Expression) {
        ...
        // @api
        auto createGetAccessorDeclaration(
            DecoratorsArray decorators,
            ModifiersArray modifiers,
            name: string | PropertyName,
            parameters: ParameterDeclaration[],
        ...
        // @api
        auto createSetAccessorDeclaration(
            DecoratorsArray decorators,
            ModifiersArray modifiers,
            name: string | PropertyName,
            parameters: ParameterDeclaration[],
        ...
        // @api
        auto createTemplateLiteralTypeSpan(type: TypeNode, literal: TemplateMiddle | TemplateTail) {
        ...
        // @api
        auto createKeywordTypeNode<TKind extends KeywordTypeSyntaxKind>(kind: TKind) {
            return createToken(kind);
        }

        // @api
        auto createTypePredicateNode(assertsModifier: AssertsKeyword, parameterName: Identifier | ThisTypeNode | string, type: TypeNode) {
        ...
        // @api
        auto createTypeReferenceNode(typeName: string | EntityName, typeArguments: TypeNode[]) {
        ...
        // @api
        auto createConstructorTypeNode(...args: Parameters<typeof createConstructorTypeNode1 | typeof createConstructorTypeNode2>) {
        ...
        /** @deprecated */
        auto createConstructorTypeNode2(
            typeParameters: TypeParameterDeclaration[],
            parameters: ParameterDeclaration[],
            type: TypeNode
        ) -> ConstructorTypeNode {
        ...
        // @api
        auto createTypeQueryNode(exprName: EntityName) {
        ...
        // @api
        auto createTypeLiteralNode(members: TypeElement[]) {
        ...
        // @api
        auto createArrayTypeNode(elementType: TypeNode) {
        ...
        // @api
        auto createTupleTypeNode(elements: (TypeNode | NamedTupleMember)[]) {
        ...
        // @api
        auto createNamedTupleMember(dotDotDotToken: DotDotDotToken, name: Identifier, questionToken: QuestionToken, type: TypeNode) {
        ...
        // @api
        auto createOptionalTypeNode(type: TypeNode) {
        ...
        // @api
        auto createRestTypeNode(type: TypeNode) {
        ...
        auto createUnionOrIntersectionTypeNode(kind: SyntaxKind::UnionType | SyntaxKind::IntersectionType, types: TypeNode[]) {
        ...
        // @api
        auto createConditionalTypeNode(checkType: TypeNode, extendsType: TypeNode, trueType: TypeNode, falseType: TypeNode) {
        ...
        // @api
        auto createInferTypeNode(typeParameter: TypeParameterDeclaration) {
        ...
        // @api
        auto createTemplateLiteralType(head: TemplateHead, templateSpans: TemplateLiteralTypeSpan[]) {
        ...
        // @api
        auto createImportTypeNode(argument: TypeNode, qualifier?: EntityName, typeArguments?: TypeNode[], isTypeOf = false) {
        ...
        // @api
        auto createParenthesizedType(type: TypeNode) {
        ...
        // @api
        auto createIndexedAccessTypeNode(objectType: TypeNode, indexType: TypeNode) {
        ...
        // @api
        auto createMappedTypeNode(readonlyToken: ReadonlyKeyword | PlusToken | MinusToken, typeParameter: TypeParameterDeclaration, nameType: TypeNode, questionToken: QuestionToken | PlusToken | MinusToken, type: TypeNode) -> MappedTypeNode {
        ...
        // @api
        auto createLiteralTypeNode(literal: LiteralTypeNode["literal"]) {
        ...
        // @api
        auto createObjectBindingPattern(elements: BindingElement[]) {
        ...
        // @api
        auto createArrayBindingPattern(elements: ArrayBindingElement[]) {
        ...
        // @api
        auto createBindingElement(dotDotDotToken: DotDotDotToken, propertyName: string | PropertyName, name: string | BindingName, initializer?: Expression) {
        ...
        auto createBaseExpression<T extends Expression>(kind: T["kind"]) {
        ...
        // @api
        auto createArrayLiteralExpression(elements?: Expression[], multiLine?: boolean) {
        ...
        // @api
        auto createObjectLiteralExpression(properties?: ObjectLiteralElementLike[], multiLine?: boolean) {
        ...
        // @api
        auto createPropertyAccessExpression(expression: Expression, name: string | Identifier | PrivateIdentifier) {
        ...
        // @api
        auto createPropertyAccessChain(expression: Expression, questionDotToken: QuestionDotToken, name: string | Identifier | PrivateIdentifier) {
        ...
        // @api
        auto createElementAccessExpression(expression: Expression, index: number | Expression) {
        ...
        // @api
        auto createElementAccessChain(expression: Expression, questionDotToken: QuestionDotToken, index: number | Expression) {
        ...
        // @api
        auto createCallExpression(expression: Expression, typeArguments: TypeNode[], argumentsArray: Expression[]) {
        ...
        // @api
        auto createCallChain(expression: Expression, questionDotToken: QuestionDotToken, typeArguments: TypeNode[], argumentsArray: Expression[]) {
        ...
        // @api
        auto createNewExpression(expression: Expression, typeArguments: TypeNode[], argumentsArray: Expression[]) {
        ...
        // @api
        auto createTaggedTemplateExpression(tag: Expression, typeArguments: TypeNode[], template: TemplateLiteral) {
        ...
        // @api
        auto createTypeAssertion(type: TypeNode, expression: Expression) {
        ...
        // @api
        auto createParenthesizedExpression(expression: Expression) {
        ...
        // @api
        auto createDeleteExpression(expression: Expression) {
        ...
        // @api
        auto createTypeOfExpression(expression: Expression) {
        ...
        // @api
        auto createVoidExpression(expression: Expression) {
        ...
        // @api
        auto createAwaitExpression(expression: Expression) {
        ...
        // @api
        auto createPrefixUnaryExpression(operator: PrefixUnaryOperator, operand: Expression) {
        ...
        // @api
        auto createPostfixUnaryExpression(operand: Expression, operator: PostfixUnaryOperator) {
        ...
        // @api
        auto createBinaryExpression(left: Expression, operator: BinaryOperator | BinaryOperatorToken, right: Expression) {
        ...
        // @api
        auto createConditionalExpression(condition: Expression, questionToken: QuestionToken, whenTrue: Expression, colonToken: ColonToken, whenFalse: Expression) {
        ...
        // @api
        auto createTemplateExpression(head: TemplateHead, templateSpans: TemplateSpan[]) {
        ...
        auto createTemplateLiteralLikeNodeChecked(kind: TemplateLiteralToken["kind"], text: string, rawText: string, templateFlags = TokenFlags.None) {
        ...
        // @api
        auto createTemplateLiteralLikeNode(kind: TemplateLiteralToken["kind"], text: string, rawText: string, templateFlags: TokenFlags) {
        ...
        // @api
        auto createSpreadElement(expression: Expression) {
        ...
        // @api
        auto createOmittedExpression() {
            return createBaseExpression<OmittedExpression>(SyntaxKind::OmittedExpression);
        }

        // @api
        auto createExpressionWithTypeArguments(expression: Expression, typeArguments: TypeNode[]) {
        ...
        // @api
        auto createAsExpression(expression: Expression, type: TypeNode) {
        ...
        // @api
        auto createNonNullExpression(expression: Expression) {
        ...
        // @api
        auto createNonNullChain(expression: Expression) {
        ...
        // @api
        auto createMetaProperty(keywordToken: MetaProperty["keywordToken"], name: Identifier) {
        ...
        // @api
        auto createTemplateSpan(expression: Expression, literal: TemplateMiddle | TemplateTail) {
        ...
        // @api
        auto createBlock(statements: Statement[], multiLine?: boolean) -> Block {
        ...
        // @api
        auto createVariableStatement(ModifiersArray modifiers, declarationList: VariableDeclarationList | VariableDeclaration[]) {
        ...
        // @api
        auto createIfStatement(expression: Expression, thenStatement: Statement, elseStatement?: Statement) {
        ...
        // @api
        auto createDoStatement(statement: Statement, expression: Expression) {
        ...
        // @api
        auto createWhileStatement(expression: Expression, statement: Statement) {
        ...
        // @api
        auto createForStatement(initializer: ForInitializer, condition: Expression, incrementor: Expression, statement: Statement) {
        ...
        // @api
        auto createForInStatement(initializer: ForInitializer, expression: Expression, statement: Statement) {
        ...
        // @api
        auto createForOfStatement(awaitModifier: AwaitKeyword, initializer: ForInitializer, expression: Expression, statement: Statement) {
        ...
        // @api
        auto createWithStatement(expression: Expression, statement: Statement) {
        ...
        // @api
        auto createLabeledStatement(label: string | Identifier, statement: Statement) {
        ...
        // @api
        auto createThrowStatement(expression: Expression) {
        ...
        // @api
        auto createTryStatement(tryBlock: Block, catchClause: CatchClause, finallyBlock: Block) {
        ...
        // @api
        auto createDebuggerStatement() {
            return createBaseNode<DebuggerStatement>(SyntaxKind::DebuggerStatement);
        }

        // @api
        auto createVariableDeclaration(name: string | BindingName, exclamationToken: ExclamationToken, type: TypeNode, initializer: Expression) {
        ...
        // @api
        auto createVariableDeclarationList(declarations: VariableDeclaration[], flags = NodeFlags.None) {
        ...
        // @api
        auto createInterfaceDeclaration(
            DecoratorsArray decorators,
            ModifiersArray modifiers,
            name: string | Identifier,
            typeParameters: TypeParameterDeclaration[],
        ...
        // @api
        auto createTypeAliasDeclaration(
            DecoratorsArray decorators,
            ModifiersArray modifiers,
            name: string | Identifier,
            typeParameters: TypeParameterDeclaration[],
        ...
        // @api
        auto createModuleBlock(statements: Statement[]) {
        ...
        // @api
        auto createNamespaceExportDeclaration(name: string | Identifier) {
        ...
        // @api
        auto createImportEqualsDeclaration(
            DecoratorsArray decorators,
            ModifiersArray modifiers,
            isTypeOnly: boolean,
            name: string | Identifier,
        ...
        // @api
        auto createImportSpecifier(propertyName: Identifier, name: Identifier) {
        ...
        // @api
        auto createNamedExports(elements: ExportSpecifier[]) {
        ...
        // @api
        auto createExportSpecifier(propertyName: string | Identifier, name: string | Identifier) {
        ...
        // @api
        auto createExternalModuleReference(expression: Expression) {
        ...
        auto createJSDocPrimaryTypeWorker<T extends JSDocType>(kind: T["kind"]) {
        ...
        auto createJSDocUnaryTypeWorker<T extends JSDocType & { type: TypeNode; }>(kind: T["kind"], type: T["type"]) -> T {
        ...
        // @api
        auto createJSDocTypeLiteral(propertyTags?: JSDocPropertyLikeTag[], isArrayType = false) -> JSDocTypeLiteral {
        ...
        // @api
        auto createBaseJSDocTag<T extends JSDocTag>(kind: T["kind"], tagName: Identifier, comment: string) {
            auto node = createBaseNode<T>(kind);
        ...
        // @api
        auto createJSDocTypedefTag(tagName: Identifier, typeExpression?: JSDocTypeExpression, fullName?: Identifier | JSDocNamespaceDeclaration, comment?: string) -> JSDocTypedefTag {
        ...
        // @api
        auto createJSDocParameterTag(tagName: Identifier, name: EntityName, isBracketed: boolean, typeExpression?: JSDocTypeExpression, isNameFirst?: boolean, comment?: string) -> JSDocParameterTag {
        ...
        // @api
        auto createJSDocPropertyTag(tagName: Identifier, name: EntityName, isBracketed: boolean, typeExpression?: JSDocTypeExpression, isNameFirst?: boolean, comment?: string) -> JSDocPropertyTag {
        ...
        // @api
        auto createJSDocSeeTag(tagName: Identifier, name: JSDocNameReference, comment?: string) -> JSDocSeeTag {
        ...
        auto createJSDocSimpleTagWorker<T extends JSDocTag>(kind: T["kind"], tagName: Identifier, comment?: string) {
        ...
        // createJSDocThisTag
        // createJSDocEnumTag
        auto createJSDocTypeLikeTagWorker<T extends JSDocTag & { typeExpression?: JSDocTypeExpression }>(kind: T["kind"], tagName: Identifier, typeExpression?: JSDocTypeExpression, comment?: string) {
            auto node = createBaseJSDocTag<T>(kind, tagName ?? createIdentifier(getDefaultTagNameForKind(kind)), comment);
            node->typeExpression = typeExpression;
            return node;
        }
        ...
        // @api
        auto createJSDocComment(comment?: string, tags?: JSDocTag[]) {
        ...
        // @api
        auto createJsxElement(openingElement: JsxOpeningElement, children: JsxChild[], closingElement: JsxClosingElement) {
        ...
        // @api
        auto createJsxSelfClosingElement(tagName: JsxTagNameExpression, typeArguments: TypeNode[], attributes: JsxAttributes) {
        ...
        // @api
        auto createJsxOpeningElement(tagName: JsxTagNameExpression, typeArguments: TypeNode[], attributes: JsxAttributes) {
        ...
        // @api
        auto createJsxClosingElement(tagName: JsxTagNameExpression) {
        ...
        // @api
        auto createJsxFragment(openingFragment: JsxOpeningFragment, children: JsxChild[], closingFragment: JsxClosingFragment) {
        ...
        // @api
        auto createJsxText(text: string, containsOnlyTriviaWhiteSpaces?: boolean) {
        ...
        // @api
        auto createJsxJsxClosingFragment() {
        ...
        // @api
        auto createJsxAttribute(name: Identifier, initializer: StringLiteral | JsxExpression) {
        ...
        // @api
        auto createJsxAttributes(properties: JsxAttributeLike[]) {
        ...
        // @api
        auto createJsxSpreadAttribute(expression: Expression) {
        ...
        // @api
        auto createJsxExpression(dotDotDotToken: DotDotDotToken, expression: Expression) {
        ...
        // @api
        auto createCaseClause(expression: Expression, statements: Statement[]) {
        ...
        // @api
        auto createDefaultClause(statements: Statement[]) {
        ...
        // @api
        auto createHeritageClause(token: HeritageClause["token"], types: ExpressionWithTypeArguments[]) {
        ...
        // @api
        auto createCatchClause(variableDeclaration: string | VariableDeclaration, block: Block) {
        ...
        // @api
        auto createPropertyAssignment(name: string | PropertyName, initializer: Expression) {
        ...
        // @api
        auto createShorthandPropertyAssignment(name: string | Identifier, objectAssignmentInitializer?: Expression) {
        ...
        // @api
        auto createSpreadAssignment(expression: Expression) {
        ...
        // @api
        auto createEnumMember(name: string | PropertyName, initializer?: Expression) {
