...
namespace ts
{
     ...
     */
        ...
        auto createPropertySignature(ModifiersArray modifiers, PropertyName name, QuestionToken questionToken, TypeNode type) -> PropertySignature;
        // auto updatePropertySignature(PropertySignature node, ModifiersArray modifiers, PropertyName name, QuestionToken questionToken, TypeNode type) -> PropertySignature;
        // auto createPropertyDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, string name, Node questionOrExclamationToken, TypeNode type, Expression initializer) -> PropertyDeclaration;
        ...
        // auto updateConstructorDeclaration(ConstructorDeclaration node, DecoratorsArray decorators, ModifiersArray modifiers, NodeArray<ParameterDeclaration> parameters, Block body) -> ConstructorDeclaration;
        // auto createGetAccessorDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, string name, NodeArray<ParameterDeclaration> parameters, TypeNode type, Block body) -> GetAccessorDeclaration;
        auto createGetAccessorDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, PropertyName name, NodeArray<ParameterDeclaration> parameters, TypeNode type, Block body) -> GetAccessorDeclaration;
        // auto updateGetAccessorDeclaration(GetAccessorDeclaration node, DecoratorsArray decorators, ModifiersArray modifiers, PropertyName name, NodeArray<ParameterDeclaration> parameters, TypeNode type, Block body) -> GetAccessorDeclaration;
        // auto createSetAccessorDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, string name, NodeArray<ParameterDeclaration> parameters, Block body) -> SetAccessorDeclaration;
        auto createSetAccessorDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, PropertyName name, NodeArray<ParameterDeclaration> parameters, Block body) -> SetAccessorDeclaration;
        // auto updateSetAccessorDeclaration(SetAccessorDeclaration node, DecoratorsArray decorators, ModifiersArray modifiers, PropertyName name, NodeArray<ParameterDeclaration> parameters, Block body) -> SetAccessorDeclaration;
        auto createCallSignature(NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type) -> CallSignatureDeclaration;
        // auto updateCallSignature(CallSignatureDeclaration node, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type) -> CallSignatureDeclaration;
        auto createConstructSignature(NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type) -> ConstructSignatureDeclaration;
        // auto updateConstructSignature(ConstructSignatureDeclaration node, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type) -> ConstructSignatureDeclaration;
        auto createIndexSignature(DecoratorsArray decorators, ModifiersArray modifiers, NodeArray<ParameterDeclaration> parameters, TypeNode type) -> IndexSignatureDeclaration;
        // auto updateIndexSignature(IndexSignatureDeclaration node, DecoratorsArray decorators, ModifiersArray modifiers, NodeArray<ParameterDeclaration> parameters, TypeNode type) -> IndexSignatureDeclaration;
        ...
        auto createFunctionTypeNode(NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type) -> FunctionTypeNode;
        // auto updateFunctionTypeNode(FunctionTypeNode node, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type) -> FunctionTypeNode;
        auto createConstructorTypeNode(ModifiersArray modifiers, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type) -> ConstructorTypeNode;
        // /** @deprecated */
        // auto createConstructorTypeNode(NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type) -> ConstructorTypeNode;
        // auto updateConstructorTypeNode(ConstructorTypeNode node, ModifiersArray modifiers, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type) -> ConstructorTypeNode;
        // /** @deprecated */
        // auto updateConstructorTypeNode(ConstructorTypeNode node, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type) -> ConstructorTypeNode;
        ...
        auto createNamedTupleMember(DotDotDotToken dotDotDotToken, Identifier name, QuestionToken questionToken, TypeNode type) -> NamedTupleMember;
        ...
        // auto updateConditionalTypeNode(ConditionalTypeNode node, TypeNode checkType, TypeNode extendsType, TypeNode trueType, TypeNode falseType) -> ConditionalTypeNode;
        ...
        auto createImportTypeNode(TypeNode argument, EntityName qualifier = undefined, NodeArray<TypeNode> typeArguments = undefined, boolean isTypeOf = false) -> ImportTypeNode;
        // auto updateImportTypeNode(ImportTypeNode node, TypeNode argument, EntityName qualifier, NodeArray<TypeNode> typeArguments, boolean isTypeOf = false) -> ImportTypeNode;
        ...
        auto createMappedTypeNode(Node readonlyToken, TypeParameterDeclaration typeParameter, TypeNode nameType, Node questionToken, TypeNode type) -> MappedTypeNode;
        // auto updateMappedTypeNode(MappedTypeNode node, Node token, TypeParameterDeclaration typeParameter, TypeNode nameType, Node questionToken, TypeNode type) -> MappedTypeNode;
        ...
        // auto updateTemplateLiteralType(TemplateLiteralTypeNode node, TemplateHead head, NodeArray<TemplateLiteralTypeSpan> templateSpans) -> TemplateLiteralTypeNode;
        ...
        // auto createBindingElement(DotDotDotToken dotDotDotToken, string propertyName, string name, Expression initializer = undefined) -> BindingElement;
        auto createBindingElement(DotDotDotToken dotDotDotToken, PropertyName propertyName, BindingName name, Expression initializer = undefined) -> BindingElement;
        // auto updateBindingElement(BindingElement node, DotDotDotToken dotDotDotToken, PropertyName propertyName, BindingName name, Expression initializer) -> BindingElement;
        ...
        // auto updateObjectLiteralExpression(ObjectLiteralExpression node, NodeArray<ObjectLiteralElementLike> properties) -> ObjectLiteralExpression;
        // auto createPropertyAccessExpression(Expression expression, string name) -> PropertyAccessExpression;
        auto createPropertyAccessExpression(Expression expression, MemberName name) -> PropertyAccessExpression;
        // auto updatePropertyAccessExpression(PropertyAccessExpression node, Expression expression, MemberName name) -> PropertyAccessExpression;
        // auto createPropertyAccessChain(Expression expression, QuestionDotToken questionDotToken, string name) -> PropertyAccessChain;
        ...
        // auto updatePropertyAccessChain(PropertyAccessChain node, Expression expression, QuestionDotToken questionDotToken, MemberName name) -> PropertyAccessChain;
        // auto createElementAccessExpression(Expression expression, number index) -> ElementAccessExpression;
        auto createElementAccessExpression(Expression expression, Expression index) -> ElementAccessExpression;
        // auto updateElementAccessExpression(ElementAccessExpression node, Expression expression, Expression argumentExpression) -> ElementAccessExpression;
        // auto createElementAccessChain(Expression expression, QuestionDotToken questionDotToken, number index) -> ElementAccessChain;
        ...
        // auto updateNewExpression(NewExpression node, Expression expression, NodeArray<TypeNode> typeArguments, NodeArray<Expression> argumentsArray) -> NewExpression;
        auto createTaggedTemplateExpression(Expression tag, NodeArray<TypeNode> typeArguments, TemplateLiteral _template) -> TaggedTemplateExpression;
        // auto updateTaggedTemplateExpression(TaggedTemplateExpression node, Expression tag, NodeArray<TypeNode> typeArguments, TemplateLiteral _template) -> TaggedTemplateExpression;
        ...
        // auto createFunctionExpression(ModifiersArray modifiers, AsteriskToken asteriskToken, string name, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type, Block body) -> FunctionExpression;
        auto createFunctionExpression(ModifiersArray modifiers, AsteriskToken asteriskToken, Identifier name, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type, Block body) -> FunctionExpression;
        // auto updateFunctionExpression(FunctionExpression node, ModifiersArray modifiers, AsteriskToken asteriskToken, Identifier name, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type, Block body) -> FunctionExpression;
        auto createArrowFunction(ModifiersArray modifiers, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type, EqualsGreaterThanToken equalsGreaterThanToken, ConciseBody body) -> ArrowFunction;
        // auto updateArrowFunction(ArrowFunction node, ModifiersArray modifiers, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type, EqualsGreaterThanToken equalsGreaterThanToken, ConciseBody body) -> ArrowFunction;
        ...
        auto createConditionalExpression(Expression condition, QuestionToken questionToken, Expression whenTrue, ColonToken colonToken, Expression whenFalse) -> ConditionalExpression;
        ...
        // auto createClassExpression(DecoratorsArray decorators, ModifiersArray modifiers, string name, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<HeritageClause> heritageClauses, NodeArray<ClassElement> members) -> ClassExpression;
        auto createClassExpression(DecoratorsArray decorators, ModifiersArray modifiers, Identifier name, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<HeritageClause> heritageClauses, NodeArray<ClassElement> members) -> ClassExpression;
        // auto updateClassExpression(ClassExpression node, DecoratorsArray decorators, ModifiersArray modifiers, Identifier name, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<HeritageClause> heritageClauses, NodeArray<ClassElement> members) -> ClassExpression;
        ...
        // auto updateExpressionWithTypeArguments(ExpressionWithTypeArguments node, Expression expression, NodeArray<TypeNode> typeArguments) -> ExpressionWithTypeArguments;
        ...
        // auto updateForStatement(ForStatement node, ForInitializer initializer, Expression condition, Expression incrementor, Statement statement) -> ForStatement;
        auto createForInStatement(ForInitializer initializer, Expression expression, Statement statement) -> ForInStatement;
        // auto updateForInStatement(ForInStatement node, ForInitializer initializer, Expression expression, Statement statement) -> ForInStatement;
        auto createForOfStatement(AwaitKeyword awaitModifier, ForInitializer initializer, Expression expression, Statement statement) -> ForOfStatement;
        // auto updateForOfStatement(ForOfStatement node, AwaitKeyword awaitModifier, ForInitializer initializer, Expression expression, Statement statement) -> ForOfStatement;
        ...
        // auto createFunctionDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, AsteriskToken asteriskToken, string name, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type, Block body) -> FunctionDeclaration;
        auto createFunctionDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, AsteriskToken asteriskToken, Identifier name, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type, Block body) -> FunctionDeclaration;
        // auto updateFunctionDeclaration(FunctionDeclaration node, DecoratorsArray decorators, ModifiersArray modifiers, AsteriskToken asteriskToken, Identifier name, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<ParameterDeclaration> parameters, TypeNode type, Block body) -> FunctionDeclaration;
        // auto createClassDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, string name, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<HeritageClause> heritageClauses, NodeArray<ClassElement> members) -> ClassDeclaration;
        auto createClassDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, Identifier name, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<HeritageClause> heritageClauses, NodeArray<ClassElement> members) -> ClassDeclaration;
        // auto updateClassDeclaration(ClassDeclaration node, DecoratorsArray decorators, ModifiersArray modifiers, Identifier name, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<HeritageClause> heritageClauses, NodeArray<ClassElement> members) -> ClassDeclaration;
        // auto createInterfaceDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, string name, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<HeritageClause> heritageClauses, NodeArray<TypeElement> members) -> InterfaceDeclaration;
        auto createInterfaceDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, Identifier name, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<HeritageClause> heritageClauses, NodeArray<TypeElement> members) -> InterfaceDeclaration;
        // auto updateInterfaceDeclaration(InterfaceDeclaration node, DecoratorsArray decorators, ModifiersArray modifiers, Identifier name, NodeArray<TypeParameterDeclaration> typeParameters, NodeArray<HeritageClause> heritageClauses, NodeArray<TypeElement> members) -> InterfaceDeclaration;
        // auto createTypeAliasDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, string name, NodeArray<TypeParameterDeclaration> typeParameters, TypeNode type) -> TypeAliasDeclaration;
        auto createTypeAliasDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, Identifier name, NodeArray<TypeParameterDeclaration> typeParameters, TypeNode type) -> TypeAliasDeclaration;
        // auto updateTypeAliasDeclaration(TypeAliasDeclaration node, DecoratorsArray decorators, ModifiersArray modifiers, Identifier name, NodeArray<TypeParameterDeclaration> typeParameters, TypeNode type) -> TypeAliasDeclaration;
        // auto createEnumDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, string name, NodeArray<EnumMember> members) -> EnumDeclaration;
        auto createEnumDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, Identifier name, NodeArray<EnumMember> members) -> EnumDeclaration;
        // auto updateEnumDeclaration(EnumDeclaration node, DecoratorsArray decorators, ModifiersArray modifiers, Identifier name, NodeArray<EnumMember> members) -> EnumDeclaration;
        auto createModuleDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, ModuleName name, ModuleBody body, NodeFlags flags = (NodeFlags)0) -> ModuleDeclaration;
        // auto updateModuleDeclaration(ModuleDeclaration node, DecoratorsArray decorators, ModifiersArray modifiers, ModuleName name, ModuleBody body) -> ModuleDeclaration;
        ...
        auto createExportAssignment(DecoratorsArray decorators, ModifiersArray modifiers, boolean isExportEquals, Expression expression) -> ExportAssignment;
        // auto updateExportAssignment(ExportAssignment node, DecoratorsArray decorators, ModifiersArray modifiers, Expression expression) -> ExportAssignment;
        auto createExportDeclaration(DecoratorsArray decorators, ModifiersArray modifiers, boolean isTypeOnly, NamedExportBindings exportClause, Expression moduleSpecifier = undefined) -> ExportDeclaration;
        ...
        // auto updateJsxElement(JsxElement node, JsxOpeningElement openingElement, NodeArray<JsxChild> children, JsxClosingElement closingElement) -> JsxElement;
        auto createJsxSelfClosingElement(JsxTagNameExpression tagName, NodeArray<TypeNode> typeArguments, JsxAttributes attributes) -> JsxSelfClosingElement;
        // auto updateJsxSelfClosingElement(JsxSelfClosingElement node, JsxTagNameExpression tagName, NodeArray<TypeNode> typeArguments, JsxAttributes attributes) -> JsxSelfClosingElement;
        auto createJsxOpeningElement(JsxTagNameExpression tagName, NodeArray<TypeNode> typeArguments, JsxAttributes attributes) -> JsxOpeningElement;
        // auto updateJsxOpeningElement(JsxOpeningElement node, JsxTagNameExpression tagName, NodeArray<TypeNode> typeArguments, JsxAttributes attributes) -> JsxOpeningElement;
        ...
        auto createJsxFragment(JsxOpeningFragment openingFragment, NodeArray<JsxChild> children, JsxClosingFragment closingFragment) -> JsxFragment;
        ...
        // /* @internal */ auto updateSyntheticReferenceExpression(SyntheticReferenceExpression node, Expression expression, Expression thisArg) -> SyntheticReferenceExpression;
        // auto createCommaListExpression(NodeArray<Expression> elements) -> CommaListExpression;
        // auto updateCommaListExpression(CommaListExpression node, NodeArray<Expression> elements) -> CommaListExpression;
        // auto createBundle(NodeArray<SourceFile> sourceFiles, NodeArray</*UnparsedSource | InputFiles*/Node> prepends = undefined) -> Bundle;
        // auto updateBundle(Bundle node, NodeArray<SourceFile> sourceFiles, NodeArray</*UnparsedSource | InputFiles*/Node> prepends = undefined) -> Bundle;
        ...
        // auto createImmediatelyInvokedFunctionExpression(NodeArray<Statement> statements, ParameterDeclaration param, Expression paramValue) -> CallExpression;
        // auto createImmediatelyInvokedArrowFunction(NodeArray<Statement> statements) -> CallExpression;
        // auto createImmediatelyInvokedArrowFunction(NodeArray<Statement> statements, ParameterDeclaration param, Expression paramValue) -> CallExpression;
        ...
        //  * @param allowSourceMaps A value indicating whether source maps may be emitted for the name.
        //  */
        // /* @internal */ auto getDeclarationName(Declaration node, boolean allowComments = false, boolean allowSourceMaps = false) -> Identifier;
        // /**
        ...
        //  * @param allowSourceMaps A value indicating whether source maps may be emitted for the name.
        //  */
        // /* @internal */ auto getNamespaceMemberName(Identifier ns, Identifier name, boolean allowComments = false, boolean allowSourceMaps = false) -> PropertyAccessExpression;
        // /**
