...
namespace ts
{
    ...
    Scanner::Scanner(ScriptTarget languageVersion,
                     ...
                     number length)
    {
        impl = ts::Impl::Scanner::createScanner(languageVersion, skipTrivia, languageVariant, textInitial, onError, start, length);
    }
    ...
    auto Scanner::reScanAsteriskEqualsToken() -> void
    {
