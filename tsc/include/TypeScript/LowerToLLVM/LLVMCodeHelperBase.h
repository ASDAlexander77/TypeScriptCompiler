...
class LLVMCodeHelperBase
{
  ...
  public:
    ...
    mlir::Value Alloca(mlir::Type llvmReferenceType, int count)
    {
        ...
        auto allocated = rewriter.create<LLVM::AllocaOp>(location, llvmReferenceType, clh.createI32ConstantOf(count));
        return allocated;
    }
