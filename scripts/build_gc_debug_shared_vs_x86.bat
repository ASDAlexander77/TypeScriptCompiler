@rem Debug counterpart of build_gc_release_shared_vs_x86.bat - Boehm built as a DLL, installed
...
@rem 3rdParty/gcdll/x86/<config>: with only the release build installed, a debug tree has no
