...
%LLVMPATH%\lld.exe -flavor link %FILENAME%.o /DEBUG:FULL /libpath:%LIBPATH% /libpath:%SDKPATH% /libpath:%UCRTPATH% /libpath:%GCLIBPATH% msvcrt.lib ucrt.lib kernel32.lib user32.lib gc-lib.lib
del %FILENAME%.o
