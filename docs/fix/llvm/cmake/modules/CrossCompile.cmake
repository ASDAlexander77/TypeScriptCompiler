...
function(build_native_tool target output_path_var)
  ...
  if(LLVM_NATIVE_PATH)
    message(STATUS "Copying native tool ${target}... '${LLVM_NATIVE_PATH}/${target}' -> '${output_path}'")
    file(COPY "${LLVM_NATIVE_PATH}/${target}" DESTINATION "${${PROJECT_NAME}_NATIVE_BUILD}/bin/")
  else()
