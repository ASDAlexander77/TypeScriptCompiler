...
function fooBar(x: { foo: string, bar: string }): void {};
function fooBat(x: { foo: string, bat: string }): void {};
...
function toString1(value: object | Function): string { return ""; };
function toString2(value: Function): string { return ""; };
...
//function save(_response: IRootResponse<string>): void {};
...
function ff(x: Foo3<string>): void {};
function gg<T>(f: (x: Foo3<T>) => void): void {};
//type Foo3<T> = T extends number ? { n: T } : { x: T };
